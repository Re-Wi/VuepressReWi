...
## 2. Deploy Rancher[（快速部署server）](https://www.rancher.com/quick-start)

### 2.1 Prepare a Linux Host（准备一个Linux虚拟机）
...
- [docker搭建rancher平台](https://zhuanlan.zhihu.com/p/620671840)